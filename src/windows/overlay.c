...
LRESULT CALLBACK overlay_proc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_PAINT: {
        ...
        if (g_app_icon) {
            ...
            DrawIconEx(hdc, iconMargin, iconY, g_app_icon, iconSize, iconSize, 0, NULL, DI_NORMAL);
        }
        ...
        HFONT font = CreateFontW(Scale(BASE_FONT_SIZE), 0, 0, 0, FW_MEDIUM, FALSE, FALSE, FALSE, DEFAULT_CHARSET,
        ...
        DrawTextW(hdc, g_display_text, -1, &textRect, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
...
static void create_overlay_window() {
    ...
    g_overlay_window =
        CreateWindowExW(WS_EX_TOPMOST | WS_EX_LAYERED | WS_EX_TOOLWINDOW | WS_EX_NOACTIVATE, OVERLAY_CLASS_NAME,
                        L"Yakety", WS_POPUP, x, y, overlayWidth, overlayHeight, NULL, NULL, g_instance, NULL);
