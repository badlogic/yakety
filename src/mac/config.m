...
const char* config_get_path(void) {
    if (g_config_path[0] == '\0') {
        snprintf(g_config_path, PATH_MAX, "%s/config.ini", get_config_dir());
    }
...
Config* config_create(void) {
    ...
    config->config_path = strdup(config_get_path());
